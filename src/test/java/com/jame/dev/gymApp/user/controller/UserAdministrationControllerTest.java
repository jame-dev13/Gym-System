...
class UserAdministrationControllerTest {
   ...
   class GetUsersPageTests {
      ...
      void invalidPageParams(String page, String size, String errorCodeExpected) throws Exception {
         ...
         then(getPageUserUseCase).shouldHaveNoInteractions();
      }
      ...
      @CsvSource(useHeadersInDisplayName = true,
         textBlock = TestDataSource.PAGINATION_ERRORS,
         nullValues = "NULL")
      @DisplayName("GET[400] Bad Request: /users/inactive?page={invalidPage}&size={invalidSize}")
      void invalidInactivePageParams(String page, String size, String errorCodeExpected) throws Exception {
         mockMvc.perform(get(URI_TEMPLATE + "/inactive")
