...
import com.jame.dev.gymApp.features.audit.domain.model.AuditLogSortProperty;
...
public class AuditLogSortApplicationResolver implements SortPropertyResolver {
   private static final Map<String, String> PROPERTY_MAP = Arrays.stream(AuditLogSortProperty.values())
