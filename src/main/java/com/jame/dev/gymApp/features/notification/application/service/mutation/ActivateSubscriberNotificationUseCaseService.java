...
@CheckLockProcess
public class ActivateSubscriberNotificationUseCaseService implements ActivateSubscriberNotificationUseCase {
   ...
   public SubscriberNotificationResponse activateNotification(AuthPrincipal principal) {
      ...
      notificationEntity.setNotifiable(true);
