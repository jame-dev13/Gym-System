...
public abstract class ControllerIdentifiable<E, DTO_OUT, DTO_IN>
   ...
   public ControllerIdentifiable(BaseCrudService<DTO_OUT, DTO_IN> service, Function<DTO_OUT, Long> idExtractor, EmailIdentifiable<E> identifiable, BaseMapper<E, DTO_OUT> mapper) {
